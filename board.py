from pieces import Piece, Pawn, Rook, Knight, Bishop, Queen, King, Kuzya
import pygame
...
class Square:
    ...
    home_piece = [Rook, Knight, Bishop, Queen, King, Bishop, Kuzya, Rook]
...
class Board:
    ...
    def draw_promotion_screen(self, win):
        ...
        if self.promoting_pawn.color == 'White':
            pygame.draw.rect(win, (73, 81, 111), (x, y, length, 5 * length))
            ...
            win.blit(Piece.images['Kuzya'][1], (x, y + 4 * length))

        else:
            pygame.draw.rect(win, (98, 121, 184), (x, y - 3 * length, length, 5 * length))
            ...
            win.blit(Piece.images['Kuzya'][0], (x, y - 4 * length))
